...
def play_alarm_sound_function(): # defined function to play alarm post fire detection using threading
    ...
    playsound.playsound('free-sound-effects-AD2A97A6.mp3',True)
...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "e8727438@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login(recipientmail, 'e8727438@gmail.com,') # Senders mail ID and password
        server.sendmail('e8727438@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
